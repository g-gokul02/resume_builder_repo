        ...
        <div>
            ...
            <div className="flex gap-4 px-20">
                ...
                <button
                    ...
                    className="
                        w-full bg-white sm:max-w-[9rem] h-48 flex flex-col items-center justify-center 
                ...
                >
                    <PlusIcon
                        className="
                            size-11 transition-all duration-300 p-2.5 
            ...
            <div className="grid grid-cols-2 sm:flex flex-wrap gap-4 px-20">
                {allResumes.map((resume, index) => {
                    const basecolor = colors[index % colors.length];

                    const bg1 = basecolor + "1A";
                    const bg2 = basecolor + "66";
                    const border = basecolor + "66";
                    const updatedText = basecolor + "CC";

                    return (
                        <button
                            key={index} onClick={()=> navigate(`/app/builder/${resume._id}`)}
                            className="
                                relative w-full sm:w-36 h-48 flex flex-col items-center 
                        ...
                        >
                            ...
                            <p
                                className="
                                    absolute bottom-1 text-[11px] group-hover:text-slate-500 
                                    transition-all duration-300 px-2 text-center
                                "
                                style={{ color: updatedText }}
                            >
                            ...
                            >
                                ...
                                <PencilIcon onClick={()=> {setEditResumeId(resume._id); setTitle(resume.title)}} className="size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors ml-2" />
                            </div>
                        </button>
                    );
                })}
            ...
            {showCreateResume && (
                ...
                >
                    <div
                        ...
                        className="relative bg-slate-50 border shadow-md rounded-lg p-6 w-full max-w-sm"
                    >
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 mb-4 rounded-md border focus:ring-green-600"
                            required
                        />
                ...
                >
                    ...
                    >
                        ...
                        <label htmlFor="resume-input" className="cursor-pointer">
                            <div className="flex flex-col items-center justify-center gap-2 border text-slate-400 border-slate-400 border-dashed rounded-md p-10 my-4 group hover:border-green-500 hover:text-green-700 transition-colors">
                                {resume ? (
