...
const Login = () => {
  ...
  try {
    ...
    dispatch(login(data));  // Or login(data.data) based on backend
    ...
    return (
        <div className="flex items-center justify-center min-h-screen  bg-gradient-to-r from-purple-200 via-pink-200 to-red-200">
